 ...
 public:
  static decltype(auto) DefaultConfig() {
    return MakeDict(
        ...
        "wfc_preset"_.Bind(std::string("MazeSimple")),
        "ensure_connected"_.Bind(true), "min_num_rooms"_.Bind(2),
        "max_num_rooms"_.Bind(6), "max_room_size"_.Bind(10),
        "key_in_box"_.Bind(true), "blocked"_.Bind(true),
        "agent_room"_.Bind(std::pair<int, int>(1, 1)), "num_quarters"_.Bind(4),
        "num_rooms_visited"_.Bind(25), "num_dists"_.Bind(18),
        "locked_room_prob"_.Bind(0.5f), "locations"_.Bind(true),
        "unblocking"_.Bind(true), "implicit_unlock"_.Bind(true),
