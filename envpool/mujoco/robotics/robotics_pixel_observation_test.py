...
"""Tests for native robotics pixel observations."""
...
class RoboticsPixelObservationTest(absltest.TestCase):
    """Pixel-observation tests for robotics tasks."""
    ...
    def test_all_robotics_tasks_align_with_render_for_three_steps(
        self,
    ) -> None:
        """All robotics tasks should match `render()` for reset + 3 steps."""
