 ...
 public:
  HopperEnv(const Spec& spec, int env_id)
      : Env<HopperEnvSpec>(spec, env_id),
        MujocoEnv(spec.config_["base_path"_] + "/mujoco/assets/hopper.xml",
        ...
        velocity_min_(spec.config_["velocity_min"_]),
        velocity_max_(spec.config_["velocity_max"_]),
        healthy_state_min_(spec.config_["healthy_state_min"_]),
        healthy_state_max_(spec.config_["healthy_state_max"_]),
        healthy_angle_min_(spec.config_["healthy_angle_min"_]),
        healthy_angle_max_(spec.config_["healthy_angle_max"_]),
