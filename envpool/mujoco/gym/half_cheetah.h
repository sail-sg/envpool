...
#ifndef ENVPOOL_MUJOCO_GYM_HALF_CHEETAH_H_
#define ENVPOOL_MUJOCO_GYM_HALF_CHEETAH_H_
...
class HalfCheetahEnvBase : public Env<EnvSpecT>, public MujocoEnv {
 ...
 public:
  ...
  void Step(const Action& action) override {
    ...
    WriteState(reward, xv, ctrl_cost, x_after, false);
  }
...
#endif  // ENVPOOL_MUJOCO_GYM_HALF_CHEETAH_H_
