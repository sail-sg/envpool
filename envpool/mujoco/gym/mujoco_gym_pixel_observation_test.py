...
"""Tests for native Gym MuJoCo pixel observations."""
...
_IMPORT_PATH = "envpool.mujoco.gym"


class MujocoGymPixelObservationTest(absltest.TestCase):
    """Pixel-observation tests for Gym MuJoCo tasks."""
