...
"""Tests for native MuJoCo Playground pixel observations."""
...
class PlaygroundPixelObservationTest(absltest.TestCase):
    """Pixel-observation tests for MuJoCo Playground tasks."""

    def test_make_spec_exposes_bchw_pixel_specs(self) -> None:
        """Checks the pixel observation shape contract."""
        assert_make_spec_exposes_bchw_pixel_specs(self, _IMPORT_PATH)

    def test_frame_stack_rolls_in_channel_dimension(self) -> None:
        """Checks frame stacking rolls through the channel dimension."""
        assert_frame_stack_rolls_in_channel_dimension(self, _IMPORT_PATH)

    def test_all_tasks_align_with_render_for_three_steps(self) -> None:
        """Checks pixel observations match render output for three steps."""
