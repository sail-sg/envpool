...
def workspace():
    ...
    maybe(
        ...
        patches = [
            ...
            "//third_party/procgen:factory.patch",
            "//third_party/procgen:bigfish.patch",
            "//third_party/procgen:bossfight.patch",
            "//third_party/procgen:caveflyer.patch",
            "//third_party/procgen:chaser.patch",
            "//third_party/procgen:climber.patch",
            "//third_party/procgen:coinrun.patch",
            "//third_party/procgen:dodgeball.patch",
            "//third_party/procgen:fruitbot.patch",
            "//third_party/procgen:heist.patch",
            "//third_party/procgen:jumper.patch",
            "//third_party/procgen:leaper.patch",
            "//third_party/procgen:maze.patch",
            "//third_party/procgen:miner.patch",
            "//third_party/procgen:ninja.patch",
            "//third_party/procgen:plunder.patch",
            "//third_party/procgen:starpilot.patch",
        ],
