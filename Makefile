...
docker-ci-launch: docker-ci
	docker run --network=host -v /home/ubuntu:/home/github-action,/dev/shm:/dev/shm -it $(PROJECT_NAME):$(DOCKER_TAG) bash

docker-dev: docker-ci
	docker run --network=host -v /:/host,/dev/shm:/dev/shm -it $(PROJECT_NAME):$(DOCKER_TAG) bash
...
docker-release-launch: docker-release
	docker run --network=host -v /:/host,/dev/shm:/dev/shm -it $(PROJECT_NAME)-release:$(DOCKER_TAG) bash
