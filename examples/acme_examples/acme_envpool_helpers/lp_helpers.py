...
def run_distributed_experiment(experiment: config.Config, num_actors: int):
  ...
  logging.info(vm_resource.describe())
  lp.launch(program, terminal="tmux_session", local_resources=resources)
