...
The implementation follows OpenAI gym \*-v4 environment,
...
`this issue <https://github.com/openai/gym/issues/2593>`_.
...
- Observation space: ``(111)``, first 13 elements for ``qpos[2:]``, next 14
  elements for ``qvel``, other elements for ``cfrc_ext`` (contact force);
